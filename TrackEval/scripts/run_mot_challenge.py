...
if __name__ == '__main__':
    ...
    # ===[Note]===: python scripts/run_mot_challenge.py --BENCHMARK MOT17 --SPLIT_TO_EVAL test --TRACKERS_TO_EVAL MPNTrack --METRICS HOTA CLEAR Identity VACE --USE_PARALLEL False --NUM_PARALLEL_CORES 1  
