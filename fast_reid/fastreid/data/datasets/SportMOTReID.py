...
class SportMOTReID(ImageDataset):
    """SPORTSMOT.
    ...
    dataset_dir = ''
    dataset_url = ''
    dataset_name = "SportMOTReID"

    def __init__(self, root='../data', **kwargs):
        # self.root = osp.abspath(osp.expanduser(root))
        self.root = "D:/classes/CS330/project/CS330_MOT/data/SportMOTReID/"
        self.dataset_dir = osp.join(self.root, self.dataset_dir)

        # allow alternative directory structure
        self.data_dir = self.dataset_dir        # 'fast_reid/datasets/'
        data_dir = osp.join(self.data_dir)    # 'fast_reid/datasets/cuhksysu-reid'
        ...
        super(SportMOTReID, self).__init__(train, query, gallery, **kwargs)
