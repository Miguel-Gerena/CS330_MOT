...
class MAML:
    def __init__(self, num_sports, max_classes, num_inner_steps, inner_lr, learn_inner_lrs, outer_lr, log_dir, device):
        meta_parameters = {}
    ...
    def _inner_loop(self, images, labels, train):
        ...
        for step in range(num_inner_steps):
            ...
            loss = (WEIGHT_PLAYER_ID * player_id_loss + WEIGHT_BBOX * (bb_left_loss + bb_top_loss + bb_width_loss + bb_height_loss)) / (WEIGHT_PLAYER_ID + 4 * WEIGHT_BBOX)
            # print("loss:", loss)
