...
def make_parser():
    ...
    parser.add_argument("--data_path", default="data/combined_train_val/", help="path to MOT data")
    parser.add_argument("--save_path", default="data/", help="Path to save the MOT-ReID dataset")
    parser.add_argument("--mot", default="", help="MOTChallenge dataset number e.g. 17, 20")
...
def main(args):
    ...
    save_path = os.path.join(args.save_path, 'MOT' + args.mot + '-ReID')
